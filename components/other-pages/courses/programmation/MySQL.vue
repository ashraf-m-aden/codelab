			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 services-details-image">
						<NuxtImg src="/img/courses/mysql.jpg" class="wow fadeInUp" alt="IT+ Code Lab"/>
					</div>
				</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6 services-details-image">
						<NuxtImg src="/img/courses/mysql 2.jpg" class="wow fadeInUp" alt="IT+ Code Lab"/>
					</div>
...
useHead({
  title: "MYSQL ",
  meta: [
    { name: "description", content: "Nos formations en base de données vont vous intéresser ! | Code Lab | Cours et Formations en informatique à Djibouti" },
