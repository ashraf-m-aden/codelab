			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 services-details-image">
						<NuxtImg src="/img/courses/gns3.jpeg" class="wow fadeInUp" alt="IT+ Code Lab"/>
					</div>
				</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6 services-details-image">
						<NuxtImg src="/img/courses/ciscogns3.jpeg" class="wow fadeInUp" alt="IT+ Code Lab"/>
					</div>
...
<script setup>
useHead({
  title: "GNS3 et Simulation Réseau ",
  meta: [
    ...
    { name: "keywords", content: "formation,gns3,simulation,réseau,informatique,cours,Djibouti,codelab" }
  ],
});</script>
