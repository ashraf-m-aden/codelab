			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 services-details-image">
						<NuxtImg src="/img/courses/switch.jpeg" class="wow fadeInUp" alt="IT+ Code Lab"/>
					</div>
				</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6 services-details-image">
						<NuxtImg src="/img/courses/server.jpeg" class="wow fadeInUp" alt="IT+ Code Lab"/>
					</div>
...
useHead({
  ...
  meta: [
    ...
    { name: "keywords", content: "formation,réseaux,avancés,informatique,cours,Djibouti,codelab" }
  ],
});
</script>
