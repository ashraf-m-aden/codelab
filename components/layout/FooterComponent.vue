      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="single-footer-widget">
            <div class="logo">
              <a href="/">
                <NuxtImg src="/img/logo.svg" alt="IT+ Code Lab" />
              </a>
            </div>
            <p>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="single-footer-widget">
            ...
            <ul class="footer-contact-info">
              ...
              <li>
                <vue-feather type="mail"/> Email:
                <a href="#">codelab.dj@gmail.com</a>
              </li>
              <li>
                <vue-feather type="phone-call"/> Phone:
            ...
            <ul class="social-links">
              ...
              <li>
                <a href="https://x.com/ITCodeLab" target="_blank" class="twitter">
        ...
        <div class="col-lg-12 col-md-12">
          <div class="copyright-area">
            <p>Copyright &copy;2025 CODELAB IT+. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </div>

    <NuxtImg src="/img/map.png" class="map" alt="map" />
    <div class="shape1">
