			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 services-details-image">
						<NuxtImg src="/img/courses/linux1.jpeg" class="wow fadeInUp" alt="IT+ Code Lab"/>
					</div>
				</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6 services-details-image">
						<NuxtImg src="/img/courses/centos.jpeg" class="wow fadeInUp" alt="IT+ Code Lab"/>
					</div>
...
useHead({
  ...
  meta: [
    ...
    { name: "keywords", content: "formation,linux,systèmes,cours,Djibouti,codelab" }
  ],
});
</script>
